...
public class SupplySyncRegionPage {
    ...
    @FindBy (xpath = "(//button[@class='sc-jJoQJp ieRzNh MuiButtonBase-root sc-hiCibw kVxtLs MuiIconButton-root MuiIconButton-sizeMedium'])[2]")
    public WebElement regionEditDeleteButton;

    @FindBy (xpath = "(//li[@class='sc-jJoQJp ieRzNh MuiMenuItem-root MuiMenuItem-gutters MuiButtonBase-root sc-jOxtWs iooOuN sc-hcupDf kXRKGO'])[5]")
